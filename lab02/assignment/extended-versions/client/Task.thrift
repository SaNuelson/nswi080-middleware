...
// MODED: Joining union for fetchable types
union Item {
    1: ItemA itemA,
    2: ItemB itemB,
    3: ItemC itemC
...
// MODED: FetchResult containing bulk items
...
service Search{
    ...
    // MODED: intialize search with specific types
    bool init(1: set<string> itemType, 2: i32 limit) throws (1: ProtocolException protocolException)

    // MODED: new fetch
    BatchFetchResult fetchBatch(1: i32 count) throws (1: ProtocolException protocolException)
}
